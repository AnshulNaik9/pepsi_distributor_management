...
app.use((req, res, next) => {
  ...
  // Support Chrome's local network access security (Private Network Access)
...
// Prevent browsers (and intermediaries) from caching API JSON — stale lists broke category UI after PATCH.
